...
public:
	...
	struct btConvex2dConvex2dAlgorithmCreateFunc :public 	btCollisionAlgorithmCreateFunc
	{
		...
		btConvex2dConvex2dAlgorithmCreateFunc(btSimplexSolverInterface*			simplexSolver, btConvexPenetrationDepthSolver* pdSolver);
		
		virtual ~btConvex2dConvex2dAlgorithmCreateFunc();
