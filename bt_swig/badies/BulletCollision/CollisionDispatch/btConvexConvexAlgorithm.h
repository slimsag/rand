...
public:
	...
	struct btConvexConvexAlgorithmCreateFunc :public 	btCollisionAlgorithmCreateFunc
	{
		...
		btConvexConvexAlgorithmCreateFunc(btSimplexSolverInterface*			simplexSolver, btConvexPenetrationDepthSolver* pdSolver);
		
		virtual ~btConvexConvexAlgorithmCreateFunc();
