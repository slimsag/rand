...
// LineSegment represents a 2D line segment composed of start and end points.
type lineSegment struct {
	Start, End lmath.Vec2
}

// sideOfPoint tells which side the point, p, lands on in relation to the line
// l.
...
func (a lineSegment) intersect(b lineSegment) (p lmath.Vec2, status int) {
	x1 := a.Start.X
	y1 := a.Start.Y
	x2 := a.End.X
	y2 := a.End.Y
	...
	if denom == 0 {
		// Collinear
		return lmath.Vec2Zero, collinear
	}
