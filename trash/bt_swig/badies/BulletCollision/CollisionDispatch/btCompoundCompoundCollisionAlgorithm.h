...
public:
	...
	struct btCompoundCompoundCollisionAlgorithmCreateFunc :public 	btCollisionAlgorithmCreateFunc
	{
	...
	struct btCompoundCompoundCollisionAlgorithmSwappedCreateFunc :public 	btCollisionAlgorithmCreateFunc
	{
		virtual	btCollisionAlgorithm* CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo& ci, const btCollisionObjectWrapper* body0Wrap,const btCollisionObjectWrapper* body1Wrap)
		{
			void* mem = ci.m_dispatcher1->allocateCollisionAlgorithm(sizeof(btCompoundCompoundCollisionAlgorithm));
