...
// Container is any object that can answer if a given boundable object is fully
// contained within the arbitrary search area defined by this interface.
//
// A container is also an intersector (which is used to test octant
// boundables).
