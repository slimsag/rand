...
type Font interface {
	// Index locates the font index for the given rune. If there is no font
	// index for the given rune then ok=false is returned and idx is
	// meaningless.
	Index(r rune) (idx FontIndex, ok bool)
